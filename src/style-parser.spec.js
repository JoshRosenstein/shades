...
describe('parseRules', () => {
  ...
  describe('Pattern matching', () => {
    ...
    it('supports inverse match syntax to allow returning multiple styles per match', () => {
      const result = parseRulesNoDebug(topSelector, {
      ...
      expect(result[topSelector]).toContain('font-weight: normal;');
      expect(result[topSelector]).toContain('color: purple;');
      expect(result[topSelector]).toContain('border: 1px solid green;');
    });
  })
})
